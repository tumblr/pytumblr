...
class TumblrRestClient(object):
    ...
    def __init__(self, consumer_key="", consumer_secret="", oauth_token="", oauth_secret="", client_id=None, oauth2_token=None, host="https://api.tumblr.com"):
        """
        ...
        :param oauth2_token: a dictionary, the user specific access token, received
                            from the /access_token endpoint
        ...
        :returns: None
        """
        if client_id and oauth2_token:
            self.request = TumblrRequest2(client_id, oauth2_token, host)
        else:
